...
const mint = async () => {
  contract.setContractHash(
    "hash-98a99e2f424a09fd688a8f430c779341ca6664232c50199d89548644eb27baea"
  );
...
const approve = async () => {
  contract.setContractHash(
    "hash-b1acd833758036848ff21448621e9a545af5e96c9a6bf27a4103d59bb925867f"
  );
  ...
  const args = RuntimeArgs.fromMap({
    operator: new CLKey(
      new CLByteArray(
        Uint8Array.from(
          Buffer.from(
            "2c2778415e856d528e2717eba8578b907de8b366b7a9860a3c63063e4a9ef2a7",
            "hex"
          )
        )
      )
